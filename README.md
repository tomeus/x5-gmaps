...
This is a lightweight Google Maps plugin for Vue 3.

<br>

## <a id="tutorials">🔗</a> Samples/examples/tutorials

:warning: These are for the previous version, so there are some differences in code, but remains similar _(enough_ 🤔 _?)_.
...
Install like any Vue 3 plugin:

```js
// ...
// TODO: Fix up actual import paths
import gmaps from '../dist/x5-gmaps.es'
...
Transpile if you want it compatible with IE, Edge, and Safari (you need to add this to your `vue.config.js` file):
